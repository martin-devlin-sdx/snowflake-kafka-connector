...
public class SnowflakeSinkServiceV2ValidationLoggingTest {
   ...
   *
   * <p>Should warn about high-performance mode but NOT warn about missing error logging.
   */
  @Test
   ...
   *
   * <p>Should NOT warn about error logging — table will be auto-created with ERROR_LOGGING.
   */
  @Test
